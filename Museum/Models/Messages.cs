...
namespace Museum.Models
{
    public class Messages
    {
        public readonly static string DefaultResponseMessage =
            $"Hi, I'm Museum Bot! I support the following commands: {Environment.NewLine}" +
            $"- 'show all' - Lists all of the previous cultural selections. {Environment.NewLine}" +
            $"- 'have we been to {{place}}?' - Indicates if specific place has been chosen. {Environment.NewLine}" +
        ...
        public readonly static string LocationListingMessage =
